    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-800">
      ...
      <main className="container mx-auto px-4 pt-24 pb-16 text-center">
        ...
        <p className="mt-4 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
          ProjectFlow helps you manage tasks, track progress, and collaborate
          with your team seamlessly. Achieve your goals faster and more
          efficiently.
        </p>
        <div className="mt-8 flex justify-center gap-4">
          {isAuthenticated ? (
            ...
            <Link
              href="/projects"
              className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105 flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 text-center border rounded-lg shadow-sm hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Organize tasks in a clean, visual interface. Set priorities,
                deadlines, and assign team members with ease.
              </p>
            </div>
            {/* Feature Card 2 */}
            <div className="p-8 text-center border rounded-lg shadow-sm hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Comment on tasks, share files, and get real-time updates to keep
                everyone in sync.
              </p>
            </div>
            {/* Feature Card 3 */}
            <div className="p-8 text-center border rounded-lg shadow-sm hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Visualize your project timeline with Gantt charts and monitor
                your team's progress with insightful reports.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join thousands of teams achieving their goals with ProjectFlow.
          </p>
          <Link
            href="/register"
            className="px-10 py-4 bg-blue-600 text-white font-bold rounded-full shadow-xl hover:bg-blue-700 transition-transform transform hover:scale-105"
          >
            Sign Up Now
          </Link>
        </div>
